...
randomLLCmissrate = [plotdata[0][3][1], plotdata[1][3][1], plotdata[3][3][1], plotdata[2][3][1]]
...
plt.legend( (bar1, bar2, bar3, bar4), ('LFU', 'FIFO', 'DRRIP', 'LRU') )
...
plt.xticks(ind+width,['1', '4', '16', '32'])
plt.legend( (bar5, bar6, bar7, bar8), ('LFU', 'FIFO', 'DRRIP', 'LRU') )
